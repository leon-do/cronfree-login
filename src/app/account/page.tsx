      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mb-10 flex items-baseline justify-between">
          ...
          <form action="/auth/signout" method="post">
            <button className="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50" type="submit">
              Sign out
            </button>
          </form>
        </div>
        ...
        <div className="m-5 bg-white shadow sm:rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-2 text-sm text-gray-500">
              <p className="m-3">Schedule Plus is a Zapier app used for recurring tasks. Use the License Key to connect.</p>
            </div>
            <div className="m-3">
